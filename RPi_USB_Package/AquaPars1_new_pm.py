...
Variant of AquaPars1.py that uses the DEM730P power meter driver
(read_power_new.py) instead of the older Prolific-based read_power.py.
"""
...
class StationController:
    ...
    - Power meter from read_power_new.PowerMeterReader
